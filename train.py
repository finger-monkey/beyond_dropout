...
print('-----------------market 技能全开 + CRE_P015_RC32 + LGPR0.4 测试-------------------')
# parser.add_argument('--data_dir',default='../data/DukeMTMC/pytorch',type=str, help='raining dir path')
...
transform_train_list = [
        ...
        LGPR(probability=0.4),
        # GL_Sketch(G=0.05, L=0.2),
        # Fuse_RGB_Gray_Sketch(G=0.05, G_rgb=0.01, S_rgb=0.01,Aug=0),
...
if opt.use_dense:
    ...
    model = ft_net(len(class_names), opt.droprate, opt.stride, circle =opt.circle, ibn=opt.ibn)                         #模型初始化
